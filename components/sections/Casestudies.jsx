...
const projects = [
  {
    ...
    description:
      "Technical Sapien sought a chatbot solution to enhance community engagement and streamline access to resources. MetaUpSpace developed an AI-powered chatbot, integrated into Technical Sapien's platform, aimed at providing personalized assistance and improving user interaction.",
  ...
  },
  {
    ...
    description:
      "BlockType aimed to create a learning platform focused on web3 technology, empowering individuals to gain the necessary skills for the decentralized web. MetaUpSpace helped design and launch this platform, featuring diverse courses and an interactive learning environment.",
...
<<<<<<< HEAD
          ...
          <div className="bg-white  ">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">
              Technical Sapien&apos;s Chatbot Solution
            </h5>
            <p className="text-sm text-gray-700 mb-4">
              Technical Sapien sought a chatbot solution to enhance community
              engagement and streamline access to resources. MetaUpSpace
              developed an AIpowered chatbot, integrated into Technical
              Sapien&apos;s platform, aimed at providing personalized assistance
          ...
          <div className="bg-white">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">
              BlockType&apos;s Web3 Learning Platform
            </h5>
            <p className="text-sm text-gray-700 mb-4">
              BlockType aimed to create a learning platform focused on web3
              technology, empowering individuals to gain the necessary skills
              for the decentralized web. MetaUpSpace helped design and launch
              this platform, featuring diverse courses and an interactive
