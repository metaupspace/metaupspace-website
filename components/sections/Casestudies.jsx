...
<div className='w-full flex justify-center items-center bg-[#ffff] py-10'>
  ...
  <p className="text-sm text-gray-700 mb-4">Our Curated Baskets make your work easy and affordable, combining top talent and the right.</p>
  <button className="inline-flex w-28  items-center justify-center px-3 py-2 text-sm font-medium rounded-3xl text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
    View
  </button>
</div>
