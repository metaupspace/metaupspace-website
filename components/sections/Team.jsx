        ...
        <Popover
          ...
          content={
            <div className="w-36 text-center p-3">
              <p
                id="profile-popover"
                className="text-center font-semibold leading-none text-gray-900 dark:text-white"
              >
                <a>Simran Makhija </a>
              </p>
              <p className="mb-4 text-center text-sm">CMO</p>
            </div>
          }
        >
          <Image
            className="w-24 focus:ring-blue-300 h-24 md:w-28 md:h-28 border-white rounded-full dark:border-gray-800"
            src={profile1}
            alt="Profile 1"
          />
        </Popover>
        <Popover
          ...
          content={
            <div className="w-36 p-3">
              ...
              <p className="mb-4 text-center text-sm">Founder & CEO</p>
            </div>
          }
        >
          <Image
        ...
        <Popover
          ...
          content={
            <div className="w-36 p-3">
              ...
              <p className="mb-4 text-center text-sm">Senior Developer</p>
            </div>
          }
        >
          <Image
        ...
        <Popover
          ...
          content={
            <div className="w-36 p-3">
              ...
              <p className="mb-4  text-center text-sm">Developer</p>
            </div>
          }
        >
          <Image
