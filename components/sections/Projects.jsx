  ...
  return (
    <section className="py-16">
      ...
      <div className='w-full flex flex-col mb-5'>
            ...
            <span className='text-gray-700 text-center font-medium text-l'>Our Curated Baskets make your work easy and affordable, combining top talent and the right tools to speed up your projects.</span>
           </div>
